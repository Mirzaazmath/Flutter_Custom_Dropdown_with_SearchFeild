...
class DropDownWithSearchField extends StatefulWidget {
  ...
  @override
  State<DropDownWithSearchField> createState() =>
      _DropDownWithSearchFieldState();
}

class _DropDownWithSearchFieldState extends State<DropDownWithSearchField> {
